...
public class RelocateState : MonoBehaviour, IGameState
{
    ...
    public void BeginState()
    {
        started = true;
        //show an intro gui
        Debug.Log("Relocate State: Started");
    ...
    {
        Debug.Log("Relocate State: Ended");
        started = false;
        ended = false;
    ...
    {
        curPhase++;
        Debug.Log("Relocate State: Phase " + curPhase);
    }
}
